use crate::{browser_svg_frame, vello_svg_frame};
        ...
        items.push((
            ...
            html!{
                <>
                    ...
                    <browser_svg_frame::BrowserSvgFrame file={format!("{baseurl}/assets/{}", path.display())} />
                    <vello_svg_frame::VellottiePlayer file={format!("{baseurl}/assets/{}", path.display())} />
                </>
            },
        ));
    }
